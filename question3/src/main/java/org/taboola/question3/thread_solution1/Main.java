...
import org.taboola.question3.thread_solution1.StringsTransformer.StringFunction;
import java.util.ArrayList;
import java.util.List;

class StringIssuesTransformer1 implements StringsTransformer.StringFunction {
    @Override
