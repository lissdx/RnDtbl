...
import org.taboola.question3.thread_solution3.StringsTransformer.StringFunction;
...
//        List<List<String>> holdResult = new ArrayList<>();
//
//        for (int i = 10; i > 0; i--) {
...
//                public void run() {
//                    try {
//                        holdResult.add(stringsTransformer.transform(stringFunctions));
...
//        }
//
//        System.out.println("After m_transform  -------------------");
//        for (List<String> stringList: holdResult){
